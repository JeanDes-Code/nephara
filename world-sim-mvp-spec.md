...
```
=== TICK 42 | Day 1 | Morning ===
  [Rowan]  @ Village Square | Chat with Elara | Heart 15 vs DC 8 | Success
           > Warm conversation about strange sounds from the Forest. [Social +20, Fun +8]
  [Elara]  @ Village Square | Move > Tavern
           > Elara walks to the Tavern.
  [Thane]  @ Forest | Cast Intent: "I want the trees to whisper my name"
           > The trees murmur "Thane" in the wind. But "name" also means
             "to name" — the forest has Named him. He belongs to it now.
             [Fun +15, Energy -8, Duration: 2 ticks]

  Needs: Rowan [H:65 E:70 F:55 S:80 Y:45] | Elara [H:40 E:60 F:70 S:50 Y:80] | Thane [H:55 E:42 F:70 S:30 Y:90]
```
